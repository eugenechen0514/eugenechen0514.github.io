...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.un7');e.setAttribute('src',(dpi>1)?'images/2018feb_180917_0253-658.jpg':'images/2018feb_180917_0253-329.jpg');};
...
wl.addAnimation($('.un9'), "0.60s", "0.00s", 1, 100);
wl.addAnimation($('.un10'), "0.60s", "0.00s", 1, 100);
wl.addAnimation($('.un11'), "0.60s", "0.00s", 1, 100);
wl.addAnimation($('.un12'), "2.00s", "0.00s", 1, 100);
wl.start();
