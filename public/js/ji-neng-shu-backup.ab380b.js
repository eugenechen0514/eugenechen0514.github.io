...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.un42');e.setAttribute('src',(dpi>1)?'images/typescriptlang-228.png':'images/typescriptlang-114.png');
var e=document.querySelector('.un43');e.setAttribute('src',(dpi>1)?'images/if_code-programming-javascript-software-develop-command-language_652581-182.png':'images/if_code-programming-javascript-software-develop-command-language_652581-91.png');
...
wl.init();
wl.addAnimation($('.un40'), "1.00s", "0.00s", 1, 100);
wl.addAnimation($('.un47'), "1.00s", "0.00s", 1, 100);
wl.addAnimation($('.un49'), "1.00s", "0.00s", 1, 100);
wl.start();
